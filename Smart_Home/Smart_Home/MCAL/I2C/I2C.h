...
typedef enum EN_I2CMasterStatusCode_t
  {
  START_CONDITION_TRANSMITTED, REPEATED_START_CONDITION_TRANSMITTED, REPEATED_START_TRANSMISSION_FAILED, SLA_W_SENT_ACK_RECEIVED, SLA_W_SENT_NACK_RECEIVED, DATA_SENT_ACK_RECEIVED, DATA_SENT_NACK_RECEIVED, ARBITRATION_LOST, SLA_R_SENT_ACK_RECEIVED, SLA_R_SENT_NACK_RECEIVED, DATA_RECEIVED_ACK_SENT, DATA_RECEIVED_NACK_SENT, ERROR
